            ...
            <ContainerDestaque>
                {
                    destaque.map((item, index) => (
                        <CardDestaque key={index}>
                            <Click href={"/produto/" + (parseInt(index) + 12)}>
                                <ProdutoImgDestaque src={item.img} alt={item.nome}/>
                            </Click>
                            <ContainerInfo>
                                <TitleCard>{item.nome}</TitleCard>
                            <Click href={"/produto/" + (parseInt(index) + 12)}>
                                <PrecoAntigoCard>{item.descricao}</PrecoAntigoCard>
                                </Click>
            ...
            <CardList>
                {
                    produtos.map((item, index) => (
                        <Card key={index}>
                            <Click href={"/produto/" + index}>
                                <ProdutoImg src={item.img} alt={item.nome}/>
                            </Click>
                            <ContainerInfo>
                            <TitleCard>{item.nome}</TitleCard>
                            <Click href={"/produto/" + index}>
